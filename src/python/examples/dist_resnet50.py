...
from data.module import CIFAR10, resnet50transform
from model.resnet import ResNet50, export_inference_model
...
def main(argv: List[str]) -> None:
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        data_module = CIFAR10(batch_size=args.batch_size, transform=resnet50transform(weights=weights))
        model = ResNet50(lr=args.lr, weights=weights)
        ...
        if args.load_path:
            ...
            model = ResNet50.load_from_checkpoint(checkpoint_path=args.load_path)
