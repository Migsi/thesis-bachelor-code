...
from data.module import CIFAR10, resnet152transform
from model.resnet import ResNet152, export_inference_model
...
def main(argv: List[str]) -> None:
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        data_module = CIFAR10(batch_size=args.batch_size, transform=resnet152transform(weights=weights))
        model = ResNet152(lr=args.lr, weights=weights)
        ...
        if args.load_path:
            ...
            model = ResNet152.load_from_checkpoint(checkpoint_path=args.load_path)
